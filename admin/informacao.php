                    ...
                    <div class="alert alert-danger" role="alert">
                        ...
                        <input type="hidden" name="id" id="id" value="<?php echo $row['id']; ?>">                            
                            ...
                            <div class="input-group">
                                <fieldset disabled>
                                    <input class="" >
                            <input name="mesa" id="mesa" class="form-control disabled" placeholder="Digite a mesa vinculada" maxlength="100" value="<?php echo $row['nome'] ?>">
                            </div>
                            <label for="cpf">Nome:</label>
                            <div class="input-group">
                            <input type="text" name="mesa" id="mesa" class="form-control" placeholder="Digite a mesa vinculada" maxlength="100" value="<?php echo $row['cpf'] ?>">
                            </div>
                            <label for="email">Nome:</label>
                            <div class="input-group">
                            <input type="text" name="mesa" id="mesa" class="form-control" placeholder="Digite a mesa vinculada" maxlength="100" value="<?php echo $row['email'] ?>">
                            </div>
