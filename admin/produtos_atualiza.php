                    ...
                    <div class="alert alert-danger" role="alert">
                        ...
                        <label for="id_tipo_produto">Tipo:</label>
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="resumo_produto" id="resumo_produto" cols="30" rows="8" class="form-control" placeholder="Digite o resumo do Produto" maxlength="100"><?php echo $row['resumo_produto'] ?></textarea>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="valor_produto" id="valor_produto" class="form-control" required min="0" step="0,01" value="<?php echo $row['valor_produto'] ?>">
                            </div>
                            ...
                            <hr>
                            <input type="submit" id="atualizar" name="atualizar" value="Atualizar" class="btn btn-danger btn-block">
                        </form>
                    </div>
                </div>
            </div>
